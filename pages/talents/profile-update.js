...
const fieldsSchma = yup.object().shape({
    ...
    address:yup.string().required('Hey,fill this field').min(10),
        ...
        <form onSubmit={handleSubmit}>
            <div className={styles.inputBlockRow}>
                ...
                <div className={styles.inputBlock}>
                    ...
                    <input type="text" id="lastName" placeholder="Surname" className={styles.inputField} value={values.lastName} onChange={handleChange}
                    onBlur={handleBlur}/>
            ...
            <div className={styles.inputBlock}>
                ...
                className={styles.inputField} value={values.phoneNumber} onChange={handleChange} onBlur={handleBlur}/>
            ...
            <div className={styles.inputBlock}>
                ...
                <select id="gender" className={styles.inputField}
                value={values.gender}
...
const styles = {
    ...
    inputBlockRow:'w-full flex md:flex-col md:flex-row md:gap-3 md:mb-4',
